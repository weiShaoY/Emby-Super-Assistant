...
<template>
  ...
  >
    ...
    <span
      class="absolute left-1/2 top-1/2 h-[2em] w-[2em] rounded-[0.8em] bg-[#ccfffc] shadow-[inset_-1px_1px_4px_0px_#f0fffe,inset_1px_-1px_4px_0px_#00bdb0,-1px_1px_2px_0px_#00bdb0] duration-[200ms] -translate-x-1/2 -translate-y-1/2 peer-checked:shadow-[inset_1px_-1px_4px_0px_#f0fffe,inset_-1px_1px_4px_0px_#00bdb0]"
    />
    ...
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
      class="absolute left-1/2 top-1/2 h-[2em] w-[2em] opacity-0 -translate-x-1/2 -translate-y-1/2 peer-checked:opacity-100"
    >
      <g
        id="SVGRepo_bgCarrier"
        stroke-width="0"
